    ...
    <div className="py-8 px-4 pb-24">
      <div className="max-w-4xl mx-auto">
        ...
        <nav className="text-sm text-gray-500 mb-4">
          ...
          <Link to={`/quiz/${subject}`} className="hover:text-blue-600">
            {subjectName}
          </Link>
          <span className="mx-2">/</span>
          <span className="text-gray-900">{questionSet.chapterName}</span>
        </nav>
          ...
          <div className="space-y-3 mb-6">
            {currentQuestion.options.map((option, index) => {
              ...
              return (
                ...
                >
                  <span className="font-medium text-gray-700 mr-3">{optionNumber}.</span>
              ...
              {currentQuestion.keywords.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-2">
                  {currentQuestion.keywords.map((keyword, i) => (
                    <span
                      key={i}
                      className="inline-block bg-gray-200 text-gray-700 text-sm px-2 py-1 rounded"
                    >
                      {keyword}
                    </span>
                  ))}
        ...
        <div className="mt-6 bg-white rounded-lg border border-gray-200 p-4">
          <h4 className="text-sm font-medium text-gray-700 mb-3">문제 이동</h4>
          <div className="flex flex-wrap gap-2">
            {questions.map((_, index) => {
              ...
              if (isCurrent) {
                ...
                btnClass = "bg-green-100 text-green-800";
              }
